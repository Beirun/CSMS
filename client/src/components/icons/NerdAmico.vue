<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" class="w-120">
    <g id="freepik--Floor--inject-1--inject-125">
      <path
        d="M97.76,419.94c84.08,43.93,220.4,43.93,304.48,0s84.09-115.14,0-159.07-220.4-43.92-304.49,0S13.67,376,97.76,419.94Z"
        style="fill: #333333"
      ></path>
    </g>
    <g id="freepik--Shadows--inject-1--inject-125">
      <path
    ...
    <g id="freepik--Pencil--inject-1--inject-125">
      <path
    ...
    <g id="freepik--Backpack--inject-1--inject-125">
      <path
    ...
    <g id="freepik--game-console--inject-1--inject-125">
      <path
    ...
    <g id="freepik--Cloud--inject-1--inject-125">
      <path
    ...
    <g id="freepik--Character--inject-1--inject-125">
      <path
      ...
      <path
        ...
        style="opacity: 0.5"
      ></path>
      <path d="M319.68,328.85l4.74-1v19c-2.86,1.22-4.68,2.36-5,4.75Z" style="fill: #455a64"></path>
      <path
      ...
      <path
        ...
        style="fill: #263238; opacity: 0.79"
      ></path>
      <path
      ...
      <path
        d="M379,287.5l-2.81-1.5,2.56-.61A1.91,1.91,0,0,1,379,287.5Z"
        style="fill: #e0e0e0; opacity: 0.5; mix-blend-mode: multiply"
      ></path>
      <path
      ...
      <path
        ...
        style="fill: #00bd7e"
      ></path>
      <rect x="259.85" y="342.64" width="11.42" height="19.55" style="fill: #ffa8a7"></rect>
      <polygon
      ...
      <circle
        ...
        cy="107.01"
        r="16.21"
        transform="translate(111.97 355.27) rotate(-76.81)"
        style="fill: #263238"
      ></circle>
      <path
      ...
      <path
        ...
        style="fill: #263238"
      ></path>
      <rect x="292.86" y="115.87" width="11.76" height="0.93" style="fill: #263238"></rect>
      <path
