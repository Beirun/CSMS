...
<template>
  ...
  <div class="h-screen min-w-[calc(100vw-15vw)] pt-20 flex flex-col pl-10 pr-5">
    ...
    <div class="pl-69 w-[57.5%] my-2 flex flex-col">
    ...
    <div class="w-full h-[calc(100%-350px)] flex justify-between mt-10">
